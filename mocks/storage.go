...
func (_m *Storage) Commit(ctx context.Context, call jetflow.Request) {
	_m.Called(ctx, call)
}
...
func (_c *Storage_Commit_Call) Return() *Storage_Commit_Call {
	_c.Call.Return()
	return _c
}

func (_c *Storage_Commit_Call) RunAndReturn(run func(context.Context, jetflow.Request)) *Storage_Commit_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: ctx, call
func (_m *Storage) Get(ctx context.Context, call jetflow.Request) jetflow.Handler {
...
func (_c *Storage_Get_Call) Return(_a0 jetflow.Handler) *Storage_Get_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Storage_Get_Call) RunAndReturn(run func(context.Context, jetflow.Request) jetflow.Handler) *Storage_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Prepare provides a mock function with given fields: ctx, call
func (_m *Storage) Prepare(ctx context.Context, call jetflow.Request) bool {
	ret := _m.Called(ctx, call)

	var r0 bool
	if rf, ok := ret.Get(0).(func(context.Context, jetflow.Request) bool); ok {
		r0 = rf(ctx, call)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_c *Storage_Prepare_Call) Return(_a0 bool) *Storage_Prepare_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Storage_Prepare_Call) RunAndReturn(run func(context.Context, jetflow.Request) bool) *Storage_Prepare_Call {
	_c.Call.Return(run)
	return _c
}

// Rollback provides a mock function with given fields: ctx, call
func (_m *Storage) Rollback(ctx context.Context, call jetflow.Request) {
	_m.Called(ctx, call)
}
...
func (_c *Storage_Rollback_Call) Return() *Storage_Rollback_Call {
	_c.Call.Return()
	return _c
}

func (_c *Storage_Rollback_Call) RunAndReturn(run func(context.Context, jetflow.Request)) *Storage_Rollback_Call {
	_c.Call.Return(run)
	return _c
}
